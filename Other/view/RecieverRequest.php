...
<html>
    ...
    <body style="background-color: ghostwhite;">
        <form action="../controller/recieverRequestVal.php" method="post" >
        <header>
            <div class="container">
                <div id="branding">
                ...
                <nav>
                    <ul>
                      ...
                      <li class="current"><a href="RecieverRequest.php"><i class="fa-solid fa-hand-holding-medical"></i> Request</a></li>
                      <li><a href="Reciever.php"><i class="fa-sharp fa-solid fa-rotate-left"></i> Go Back</a></li>
      ...
      <fieldset>
         ...
         <table>
            ...
            <tr>
                ...
                Donor's Username:
                <input type="text" name="donorusername">
